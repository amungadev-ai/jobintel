...
;
const metadata = {
    title: "KaziMatch — Smart Job Matching for Kenyan Professionals",
    description: "Upload your CV and get matched with the right jobs in Kenya. AI-powered career trajectory matching for Kenyan professionals.",
    keywords: [
        "KaziMatch",
        "Kenya",
        "jobs",
    ...
    openGraph: {
        title: "KaziMatch — Smart Job Matching for Kenyan Professionals",
        description: "Upload your CV and get matched with the right jobs in Kenya.",
        siteName: "KaziMatch",
        type: "website"
    },
    twitter: {
